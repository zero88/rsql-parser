...
image:https://github.com/zero88/rsql-parser/actions/workflows/build.yml/badge.svg["Build Status", link="https://github.com/zero88/rsql-parser/actions/workflows/build.yml"]
image:https://img.shields.io/github/v/release/zero88/rsql-parser?include_prereleases[GitHub release (latest SemVer including pre-releases), link="https://github.com/zero88/rsql-parser/releases"]
image:https://img.shields.io/nexus/r/io.github.zero88/rsql-parser?server=https%3A%2F%2Foss.sonatype.org[Sonatype Nexus (Releases), link="https://search.maven.org/artifact/io.github.zero88/rsql-parser"]
image:https://img.shields.io/nexus/s/io.github.zero88/rsql-parser?server=https%3A%2F%2Foss.sonatype.org[Sonatype Nexus (Snapshots), link="https://search.maven.org/artifact/io.github.zero88/rsql-parser"]
image:https://sonarcloud.io/api/project_badges/measure?project=zero88_rsql-parser&metric=coverage["Coverage Status", link="https://sonarcloud.io/summary/overall?id=zero88_rsql-parser"]
image:https://sonarcloud.io/api/project_badges/measure?project=zero88_rsql-parser&metric=security_rating["Security Status", link="https://sonarcloud.io/summary/overall?id=zero88_rsql-parser"]
image:https://sonarcloud.io/api/project_badges/measure?project=zero88_rsql-parser&metric=reliability_rating["Reliability Status", link="https://sonarcloud.io/summary/overall?id=zero88_rsql-parser"]
image:https://sonarcloud.io/api/project_badges/measure?project=zero88_rsql-parser&metric=sqale_rating["Maintainability Status", link="https://sonarcloud.io/summary/overall?id=zero88_rsql-parser"]
...
----
// Gradle groovy
implementation 'io.github.zero88:rsql-parser:2.2.0'
----
